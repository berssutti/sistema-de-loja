...
public class ControlDados {
	 ...
	 * @return boolean, true indicando que a opera��o foi bem sussedida
	 */
	public boolean cadastrarEditarCliente(String[] dadosCliente) {
		// Condi��o para editar e cadastrar cliente
...
//		}
	 ...
	 */
		public boolean deletarCliente(int i) {
			...
			if(i == (dados.getQtdClientes() - 1)) { // O cliente a ser removido est� no final do array
...
//			}
		...
		public boolean deletarFuncionario(int i) {
			...
			if(i == (dados.getQtdAFuncionarios() - 1)) { // O funcionario a ser removido est� no final do array
		 ...
		 * @param dadosGeladeira, que cont�m a geladeirae seus dados e a serem editados ou criados
		 * @return boolean, true indicando que a opera��o foi bem sussedida
		 */
...
//			}
		...
		public boolean deletarGeladeira(int i) {
			...
			if(i == (dados.getQtdGeladeiras() - 1)) { // O Geladeira a ser removido est� no final do array
				dados.setQtdGeladeiras(dados.getQtdGeladeiras() - 1);
				dados.getGeladeira()[dados.getQtdGeladeiras()] = null;
				return true;
			} else { // o Geladeira a ser removido est� no meio do array
				int cont = 0;
		 ...
		 * @param dadosMicroondas, que cont�m o microondas e seus dados a serem editados ou criados
		 * @return boolean, true indicando que a opera��o foi bem sussedida
		 */
...
//			}
		...
		public boolean deletarMicroondas(int i) {
			...
			if(i == (dados.getQtdMicroondas() - 1)) { // O Microondas a ser removido est� no final do array
				dados.setQtdMicroondas(dados.getQtdMicroondas() - 1);
				dados.getMicroondas()[dados.getQtdMicroondas()] = null;
				return true;
			} else { // o Microondas a ser removido est� no meio do array
				int cont = 0;
		...
		/**
		 * Cadastra novo lava lou�as ou edita uma ja existente
		 * @param dadosLavaLoucas, que cont�m a lava lou�as e seus dados a serem editados ou criados
		 * @return boolean, true indicando que a opera��o foi bem sussedida
		 */
...
//			}
		/**
		 * Deleta a lava lou�as escolhida
		 * @param i, que indica a posicao do lava lou�as no array
		 * @return boolean, true indicando que a opera��o foi bem sussedida
		 */
		public boolean deletarLavaLoucas(int i) {
			String LavaLoucasRemovido = dados.getLavaLoucas()[i].getNome();

			if(i == (dados.getQtdlavaLoucas() - 1)) { // O Lava Lou�as a ser removido est� no final do array
				dados.setQtdlavaLoucas(dados.getQtdlavaLoucas() - 1);
				dados.getLavaLoucas()[dados.getQtdlavaLoucas()] = null;
				return true;
			} else { // o Lava Lou�as a ser removido est� no meio do array
				int cont = 0;
		 ...
		 * @param dadosMesa, que cont�m a mesa e seus dados a serem editados ou criados
		 * @return boolean, true indicando que a opera��o foi bem sussedida
		 */
...
//				}
		...
		public boolean deletarMesa(int i) {
			...
			if(i == (dados.getQtdMesas() - 1)) { // A Mesa a ser removida est� no final do array
				dados.setQtdMesas(dados.getQtdMesas() - 1);
				dados.getMesa()[dados.getQtdMesas()] = null;
				return true;
			} else { // A Mesa a ser removida est� no meio do array
				int cont = 0;
...
//				}
		...
		public boolean deletarCadeira(int i) {
			...
			if(i == (dados.getQtdCadeiras() - 1)) { // A Cadeira a ser removida est� no final do array
				dados.setQtdCadeiras(dados.getQtdCadeiras() - 1);
				dados.getCadeira()[dados.getQtdCadeiras()] = null;
				return true;
			} else { // A Cadeira a ser removida est� no meio do array
				int cont = 0;
		 ...
		 * @param dadosArmario, que cont�m o armario e seus dados a serem editados ou criados
		 * @return boolean, true indicando que a opera��o foi bem sussedida
		 */
...
//				}
		...
		public boolean deletarArmario(int i) {
			...
			if(i == (dados.getQtdArmarios() - 1)) { // O Armario a ser removido est� no final do array
				dados.setQtdArmarios(dados.getQtdArmarios() - 1);
				dados.getArmario()[dados.getQtdArmarios()] = null;
				return true;
			} else { // o Armario a ser removido est� no meio do array
				int cont = 0;
		 ...
		 * @param CPF, representa o cpf digitado pelo usu�rio
		 * @return int, indica a posi��o do cliente com o cpf indicado
		 */
		 ...
		 * @param CPF, representa o cpf digitado pelo usu�rio
		 * @return int, indica a posi��o do funcionario com o cpf indicado
		 */
